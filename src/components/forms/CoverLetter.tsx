  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col gap-6 text-lg">
        ...
        {/* Company Applying To */}
        <div>
          <label htmlFor="companyApplyingTo" className="block text-teal-700 font-medium mb-2">
        ...
        <div>
          ...
          {formData.resumeUpload && (
            <a
              href={formData.resumeUpload}
              target="_blank"
              rel="noopener noreferrer"
              className="text-teal-600 text-sm mt-2 inline-block"
            >
